...
export default class extends Component {
    ...
    setUrlTitleInputValueAutoGenerate = () => {
        const curTitleInputValue = this.state.titleInputValue
            .trim()
            .toLowerCase();
    ...
    submitEditPostRequest = () => {
        if (!this.state.titleInputValue) {
            ...
            this.setState({
                submitError: true,
                errorMsg: "URL title field is required.",
            });
            ...
            this.setState({
                submitError: true,
                errorMsg: "Image URL field is required.",
            });
        } else if (!this.state.markdownInputValue) {
            this.setState({
                submitError: true,
                errorMsg: "Markdown content field is required.",
            });
        } else if (!this.state.seoTitleTagInputValue) {
            this.setState({
                submitError: true,
                errorMsg: "SEO title field is required.",
            });
        } else if (!this.state.metaDescriptionInputValue) {
            this.setState({
                submitError: true,
                errorMsg: "Meta description field is required.",
            });
        } else {
            this.setState({
                submitSuccess: false,
                                ...
                                <div className="edit-blog-post-form-section">
                                    ...
                                    <div className="edit-blog-post-form-section-input">
                                        <input
                                            ...
                                            onChange={
                                                this.updateUrlTitleInputValue
                                            }
                                        />
                                        <span
                                            onClick={() =>
                                                this.setUrlTitleInputValueAutoGenerate()
                                            }
                                ...
                                <div className="edit-blog-post-form-section">
                                    ...
                                    <div className="edit-blog-post-form-section-input">
                                        <input
                                            ...
                                            onChange={
                                                this.updateSeoTitleTagInputValue
                                            }
                                        />
                                        <span
                                            className={
